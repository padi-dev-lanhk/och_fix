...
?>
<?php if($check_post_gallery == 'gallery') { ?>
	<div id="wp-spaios-nivoslider-<?php echo $unique; ?>" class="nivoSlider nivo-<?php echo $design_type; ?> wp-spaios-nivoslider-container" style="max-width:<?php echo $width_nivo; ?>px; margin: 0 auto;">
...
<?php } if($check_post_gallery == 'post') { ?>
	<div id="wp-spaios-nivoslider-<?php echo $unique; ?>" class="<?php echo $design_type; ?> nivoSlider wp-spaios-nivoslider-container" style="max-width:<?php echo $width_nivo; ?>px; margin: 0 auto;">
		<?php if ( $query->have_posts() ) :
			while ( $query->have_posts() ) : $query->the_post();
				...
				$image_excerpt_cont = esc_attr(wp_spaios_get_post_excerpt( $post->ID, get_the_content(), $words_limit, $content_tail ));
