...
if($check_post_gallery == 'gallery') { ?>
	<div id="wp-spaios-owl-<?php echo $unique; ?>" class="owl-carousel owl-<?php echo $design_type; ?> wp-spaios-owlslider-container">
...
<?php } if($check_post_gallery == 'post') { ?>
	<div id="wp-spaios-owl-<?php echo $unique; ?>" class="<?php echo $design_type; ?> owl-carousel wp-spaios-owlslider-container">
