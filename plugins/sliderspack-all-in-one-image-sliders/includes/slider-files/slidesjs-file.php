...
<?php if($check_post_gallery == 'gallery') { ?>
	<div id="wp-spaios-responsive-<?php echo $unique; ?>" class="responsive-slider slides-<?php echo $design_type; ?> wp-spaios-responsive-slider-container" >
...
<?php } if($check_post_gallery == 'post') { ?>
	<div id="wp-spaios-responsive-<?php echo $unique; ?>" class="<?php echo $design_type; ?> responsive-slider wp-spaios-responsive-slider-container" >
