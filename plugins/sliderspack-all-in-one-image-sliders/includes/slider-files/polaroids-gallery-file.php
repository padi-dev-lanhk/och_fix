...
if($check_post_gallery == 'gallery') { ?>
	<div id="wp-spaios-polaroids-<?php echo $unique; ?>" class="photostack polaroids-<?php echo $design_type; ?> photostack-start wp-spaios-pol-gallery-container">
		<div>
...
<?php } if($check_post_gallery == 'post') { ?>
	<div id="wp-spaios-polaroids-<?php echo $unique; ?>" class="<?php echo $design_type; ?> photostack photostack-start wp-spaios-pol-gallery-container">
		<div>
