...
if($check_post_gallery == 'gallery') { ?>
	<div id="wp-spaios-swiper-<?php echo $unique; ?>" class="swiper-container swiper-<?php echo $design_type; ?> wp-spaios-swiper-wrapper" data-img-height="<?php echo $slider_wrap_height; ?>">
...
<?php } if($check_post_gallery == 'post') { ?>
	<div id="wp-spaios-swiper-<?php echo $unique; ?>" class="<?php echo $design_type; ?> swiper-container wp-spaios-swiper-wrapper" data-img-height="<?php echo $slider_wrap_height; ?>">
		<div class="swiper-wrapper wp-spaios-swiper-carousel">
			<?php
				if ( $query->have_posts() ) :
