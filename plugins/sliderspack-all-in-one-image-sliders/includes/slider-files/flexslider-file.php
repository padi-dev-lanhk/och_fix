...
if($check_post_gallery == 'gallery') { ?>
	<div id="wp-spaios-flexslider-<?php echo $unique; ?>" class="flexslider flex-<?php echo $design_type; ?> wp-spaios-flexslider-container wp-spaios-hidden" >
		<div class="slides">
...
<?php } if($check_post_gallery == 'post') { ?>
	<div id="wp-spaios-flexslider-<?php echo $unique; ?>" class="<?php echo $design_type; ?> flexslider wp-spaios-flexslider-container wp-spaios-hidden" >
		<div class="slides">
