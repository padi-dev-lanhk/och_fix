...
<head>
  ...
  <link rel="stylesheet" type="text/css" media="screen" href="http://och.vn/cms/css/custom2.css">
...
<body id="body_set" class="opening hide-UI view-2D zoom-large data-close pageLoad controls-close body_bgr <?php if (!isset($_COOKIE['wp_cookie_bom'])) {
          ...
          <div class="list_menu_item">
            ...
            <ul id="menu-headnavi" class="list-menu">
              <li class="menu-item">
                ...
                <a href="/och-hospitality/">Giới thiệu</a>
              </li>
              <li class="menu-item">
      ...
      <div id="solar-system" class="earth">
        <div id="saturn" class="orbit">
          ...
          <div class="pos pos_sun">
            <div class="planet">
              <div class="box-padi">
                <a href="/och-hospitality/" target="_blank" class="hover-padi"></a>
              </div>
            </div>
          </div>
