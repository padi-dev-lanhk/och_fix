	...
	<div class="meun_trangcon menu_gioithieu">
		<div class="list_menu_item_child">
			<div class="icon_menu_gt">
				<img style="width:30px;" src="http://och.paditech.com/wp-content/uploads/2019/10/img_menu_b.png" alt"menu_opne">
			</div>
			<div class="icon_close_gt">
				<img style="width:18px;" src="http://och.paditech.com/wp-content/uploads/2019/10/cross.png" alt"menu_close">
			</div>
