...
?>
  ...
  <body id="body_set" class="opening lanhk-update hide-UI view-2D zoom-large data-close controls-close pageLoad body_bgr <?php if (!isset($_COOKIE['wp_cookie_bom'])) { setcookie('wp_cookie_bom', '1', strtotime('+1 day')); echo "dont-cookie"; }else{ echo "save-cookie";} ?>">
    <div class="header">
      <div class="container">
        <div class="img_logo">
          <a href="#">
