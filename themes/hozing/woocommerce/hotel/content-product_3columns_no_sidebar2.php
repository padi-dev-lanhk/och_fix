...
$hozing_room_grid_m  = wp_get_attachment_image_url( get_post_thumbnail_id(), 'hozing_room_grid_m' );
$img  = wp_get_attachment_image_url( get_post_thumbnail_id(), 'large' );

?>

<div class="rental_item item colums_no_sidebar_3v2 col-lg-4 col-md-6">
    <div class="border-box">
        <div class="wrap_img">
            <div class="images_thumb">
               <img src="<?php echo esc_url($hozing_room_grid_m);?>" />
            </div>
