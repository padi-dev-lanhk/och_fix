...
$img_hozing_h  = wp_get_attachment_image_url( get_post_thumbnail_id(), 'hozing_h' );
$img  = wp_get_attachment_image_url( get_post_thumbnail_id(), 'large' );

?>

<div class="rental_item item room_list_with_sidebar col-lg-12">
    <div class="border-box row">
        <div class="wrap_img col-lg-6 col-md-12">
            <div class="images_thumb">
               <img src="<?php echo esc_url($img_hozing_h); ?>" />
            </div>
